...
def feature_derivative(errors, feature):
	derivative = 2 * np.dot(feature.transpose(), errors)
	return derivative
...
double_weights = regression_gradient_descent(feature_matrix, output, initial_weights, step_size, tolerance)

(test_feature_matrix, test_output) = get_numpy_data(test_data, model_features, my_output)

double_prediction = predict_outcome(test_feature_matrix, double_weights)
...
print "ANSWER Q19:\t" + "1: " + str(simple_RSS) + "\t2: " + str(double_RSS)
